...
class Profile(DetailView):
    model = Administrator
    template_name = 'foji/dashboard/administrator_profile.html'
...
class Creacion(CreateView):
    model = Administrator
    fields = '__all__'
    template_name = 'foji/dashboard/administrador_add.html'
...
class Delete(DetailView):
    model = Administrator
    fields = '__all__'
    template_name = 'foji/dashboard/administrador_del.html'
