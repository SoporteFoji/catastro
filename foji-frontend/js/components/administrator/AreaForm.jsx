...
class AreaForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      provincias: this.props.regiones,
      tabs: [
  ...
  render() {
    return (
      <form method="POST" action="" id="area" ref={(form) => { this.forms.area = form; }}>
        <div className="row">
          <div className="col-md-6 pt-3 pb-3 p-sm-5">
            <div className="row form-group">
              <div className="col-lg-4">
                <label htmlFor="idArea">Id Area:</label>
              </div>
            ...
            <div className="row form-group">
              <div className="col-lg-4">
                <label htmlFor="nombreArea">Nombre Area:</label>
              </div>
              <div className="col-lg-8">
                <Input
                  id="nombreArea"
            ...
            <div className="row form-group">
              <div className="col-lg-4">
                <label htmlFor="codeArea">Código Area:</label>
              </div>
              <div className="col-lg-8">
                <Input
                  id="codeArea"
