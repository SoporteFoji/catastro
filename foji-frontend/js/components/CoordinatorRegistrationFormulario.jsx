...
class CoordinatorRegistrationFormulario extends Component {
  render() {
    return (
      <div className="row">
...
CoordinatorRegistrationFormulario.defaultProps = {
  errors: {
    role: '',
...
export default CoordinatorRegistrationFormulario;
